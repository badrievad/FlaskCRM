...
try:
    ...
    workbook = excel.Workbooks.Open(
        r"C:\Users\ШалапугинД\PycharmProjects\FlaskCRM\Testing calc\Leasing calc vers 1.xlsm"
    )
    ...
    workbook.SaveAs(
        r"C:\Users\ШалапугинД\PycharmProjects\FlaskCRM\Testing calc\Leasing calc vers 1_1.xlsm",
        FileFormat=52,
    )
