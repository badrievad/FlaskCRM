...
document
	...
	.addEventListener('input', function () {
		...
		document.getElementById('initial-payment-percent').value =
			percentValue.toFixed(2)
		document.getElementById('initial-payment-value').value =
			initialPaymentValue.toFixed(0)
		document.getElementById('initial-payment-value-display').value =
			formatNumber(initialPaymentValue)
		updateCreditValue() // Добавлен вызов для обновления значения кредита
	})

document
	.getElementById('initial-payment-value-display')
	.addEventListener('input', function () {
		var inputValue = this.value.trim().toLowerCase()
...
document
	.getElementById('initial-payment-percent')
	.addEventListener('blur', function () {
		var inputValue = this.value.trim().toLowerCase()
		...
		document.getElementById('initial-payment').value = percentValue
		document.getElementById('initial-payment-percent').value =
			percentValue.toFixed(2) // Установите значение обратно в поле
		document.getElementById('initial-payment-value').value =
			initialPaymentValue.toFixed(0)
		document.getElementById('initial-payment-value-display').value =
			formatNumber(initialPaymentValue)
...
document
	.getElementById('cost-display')
	.addEventListener('keypress', allowOnlyNumbers)
document
	.getElementById('initial-payment-value-display')
	.addEventListener('keypress', allowOnlyNumbers)
document
	.getElementById('credit-value-display')
	.addEventListener('keypress', allowOnlyNumbers)
...
document
	.getElementById('foreign-cost-display')
	.addEventListener('input', function () {
		var value = parseFormattedNumber(this.value)
...
function getExchangeRate(currency) {
	const exchangeRates = {
		usd: parseFloat(
			document
				.getElementById('today-usd')
				.textContent.replace(/[^\d,.-]/g, '')
				.replace(',', '.')
		),
		eur: parseFloat(
			document
				.getElementById('today-eur')
				.textContent.replace(/[^\d,.-]/g, '')
				.replace(',', '.')
		),
		cny: parseFloat(
			document
				.getElementById('today-cny')
				.textContent.replace(/[^\d,.-]/g, '')
				.replace(',', '.')
		),
	}
...
function updateCostInRubles() {
	...
	const foreignCost = parseFormattedNumber(
		document.getElementById('foreign-cost-display').value
	)
...
function updateCreditValue() {
	var totalCost = parseFloat(document.getElementById('cost-value').value)
	var creditPercent = parseFloat(
		document.getElementById('credit-percent').value
	)
	var initialPaymentPercent = parseFloat(
		document.getElementById('initial-payment-percent').value
	)
	...
	document.getElementById('credit-value-display').value =
...
document
	.getElementById('commission-value')
	.addEventListener('blur', function () {
		if (this.value > 3) {
			this.value = 3
		}
...
document
	.getElementById('commission-lkmb')
	.addEventListener('input', function () {
		document.getElementById('commission-lkmb-value').value = this.value
	})

document
	.getElementById('commission-lkmb-value')
	.addEventListener('blur', function () {
		if (this.value > 3) {
			this.value = 3
		}
...
document
	.getElementById('agent-commission')
	.addEventListener('input', function () {
		document.getElementById('agent-commission-value').value = this.value
	})

document
	.getElementById('agent-commission-value')
	.addEventListener('blur', function () {
...
document
	.getElementById('manager-bonus-value')
	.addEventListener('blur', function () {
		var value = this.value
...
document
	.getElementById('depr-transport-display')
	.addEventListener('input', function () {
		var value = parseInt(this.value.replace(/\D/g, ''), 10)
...
document
	.getElementById('stationery-display')
	.addEventListener('input', function () {
		var value = parseInt(this.value.replace(/\D/g, ''), 10)
...
document
	.getElementById('internet-display')
	.addEventListener('input', function () {
		var value = parseInt(this.value.replace(/\D/g, ''), 10)
...
document
	.getElementById('bank-pledge-display')
	.addEventListener('input', function () {
		var value = parseInt(this.value.replace(/\D/g, ''), 10)
...
document
	.getElementById('express-display')
	.addEventListener('input', function () {
		var value = parseInt(this.value.replace(/\D/g, ''), 10)
...
document
	...
	.addEventListener('keypress', allowOnlyNumbers)
document
	.getElementById('gsm-display')
	.addEventListener('keypress', allowOnlyNumbers)
document
	.getElementById('mail-display')
	.addEventListener('keypress', allowOnlyNumbers)
document
	.getElementById('depr-transport-display')
	.addEventListener('keypress', allowOnlyNumbers)
...
document
	...
	.addEventListener('input', function () {
		var value = parseInt(this.value, 10)
		document.getElementById('depr-transport-display').value =
			formatNumber(value)
	})
...
document
	.querySelectorAll('[id^="health-insurance"]')
...
document
	.querySelectorAll('[id^="other-insurance"]')
	.forEach(function (element) {
		element.addEventListener('blur', function () {
			this.value = formatNumber(parseFormattedNumber(this.value))
			if (this.value.trim() === 'не число') {
...
document.addEventListener('DOMContentLoaded', function () {
	...
	function populateForm(data) {
		...
		document.getElementById('commission-lkmb-value').value =
			calc.lkmb_commission
		document.getElementById('commission-lkmb').value = calc.lkmb_commission
		document.getElementById('agent-commission-value').value =
			calc.agent_commission
		...
		document.getElementById('input-period').value = formatDate(
			calc.input_period
		)
		...
		document.getElementById('differential-payment-increase-factor').value =
			calc.differential_payment_increase_factor
		document.getElementById('months-regressive-payments').value =
			calc.months_regressive_payments
		...
		var depositButtons = document.querySelectorAll(
			'.button-group-deposit button'
		)
		...
		var redemptionButtons = document.querySelectorAll(
			'.button-group-redemption button'
		)
		...
		if (tranches) {
			...
			document.getElementById('tranche1-own-fee').value =
				tranches.tranche_1_own_fee
			document.getElementById('tranche1-credit-date').value = formatDate(
				tranches.tranche_1_credit_date
			)
			document.getElementById('payment-deferment1').value =
				tranches.tranche_1_payment_deferment
			...
			document.getElementById('tranche2-own-fee').value =
				tranches.tranche_2_own_fee
			document.getElementById('tranche2-credit-date').value = formatDate(
				tranches.tranche_2_credit_date
			)
			document.getElementById('payment-deferment2').value =
				tranches.tranche_2_payment_deferment
			...
			document.getElementById('tranche3-own-fee').value =
				tranches.tranche_3_own_fee
			document.getElementById('tranche3-credit-date').value = formatDate(
				tranches.tranche_3_credit_date
			)
			document.getElementById('payment-deferment3').value =
				tranches.tranche_3_payment_deferment
			...
			document.getElementById('tranche4-own-fee').value =
				tranches.tranche_4_own_fee
			document.getElementById('tranche4-credit-date').value = formatDate(
				tranches.tranche_4_credit_date
			)
			document.getElementById('payment-deferment4').value =
				tranches.tranche_4_payment_deferment
			...
			document.getElementById('tranche5-own-fee').value =
				tranches.tranche_5_own_fee
			document.getElementById('tranche5-credit-date').value = formatDate(
				tranches.tranche_5_credit_date
			)
			document.getElementById('payment-deferment5').value =
				tranches.tranche_5_payment_deferment
		}
		if (insurances) {
			document.getElementById('insurance-casko1').value =
				insurances.insurance_casko1
			document.getElementById('insurance-osago1').value =
				insurances.insurance_osago1
			document.getElementById('health-insurance1').value =
				insurances.health_insurance1_str
			document.getElementById('other-insurance1').value =
				insurances.other_insurance1_str

			document.getElementById('insurance-casko2').value =
				insurances.insurance_casko2
			document.getElementById('insurance-osago2').value =
				insurances.insurance_osago2
			document.getElementById('health-insurance2').value =
				insurances.health_insurance2_str
			document.getElementById('other-insurance2').value =
				insurances.other_insurance2_str

			document.getElementById('insurance-casko3').value =
				insurances.insurance_casko3
			document.getElementById('insurance-osago3').value =
				insurances.insurance_osago3
			document.getElementById('health-insurance3').value =
				insurances.health_insurance3_str
			document.getElementById('other-insurance3').value =
				insurances.other_insurance3_str

			document.getElementById('insurance-casko4').value =
				insurances.insurance_casko4
			document.getElementById('insurance-osago4').value =
				insurances.insurance_osago4
			document.getElementById('health-insurance4').value =
				insurances.health_insurance4_str
			document.getElementById('other-insurance4').value =
				insurances.other_insurance4_str

			document.getElementById('insurance-casko5').value =
				insurances.insurance_casko5
			document.getElementById('insurance-osago5').value =
				insurances.insurance_osago5
			document.getElementById('health-insurance5').value =
				insurances.health_insurance5_str
			document.getElementById('other-insurance5').value =
				insurances.other_insurance5_str
		}
...
document
	.querySelectorAll(
		'.button-group-nds, .button-group-deposit, .button-group-redemption'
	)
	.forEach(group => {
...
function setValidationHandlers() {
	const inputs = document.querySelectorAll(
		'input[type="text"][id^="insurance-casko"], input[type="text"][id^="insurance-osago"], input[type="text"][id^="tranche"]'
	)
...
document
	.querySelectorAll('input[id^="payment-deferment"]')
...
document
	.getElementById('payment-deferment1')
	.addEventListener('input', function () {
...
document
	.getElementById('tranche1-credit-date')
	.addEventListener('input', function () {
		const value = this.value

		// Обновляем другие поля
		const fields = [
			'tranche2-credit-date',
			'tranche3-credit-date',
			'tranche4-credit-date',
			'tranche5-credit-date',
		]
		fields.forEach(function (id) {
			document.getElementById(id).value = value
		})
...
document
	.getElementById('date-warning-icon')
